package com.example.hezhanheng.scrollactivity.views;
...
import com.example.hezhanheng.scrollactivity.R;

/**
 * Created by HeZhanHeng on 2018/12/4.
 */
    ...
    public CountDownProgressView(Context context, AttributeSet attrs) {
        ...
        if (typedArray != null){
            ...
            if (typedArray.hasValue(R.styleable.CountDownProgress_textColor)){
                ...
                textColor = typedArray.getColor(R.styleable.CountDownProgress_textColor, Color.parseColor("#000000"));
